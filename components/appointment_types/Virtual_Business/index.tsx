          ...
          <div className="flex flex-col-reverse pt-4 mt-6 md:gap-8 md:flex-row md:col-span-2 justify-evenly sm:mt-0">
            <div className="w-full py-4">
              <p className="pb-4 font-light text-gray-800">
                Schedule a{" "}
                <span className="font-bold">virtual appointment</span>
                {", "}
                to connect with a Certified Public Account and have your tax
                return completed from the safety of your own home.
              </p>
              <p className="pb-4 font-light text-gray-800">
                Personal + Business returns take approximately{" "}
                <span className="font-bold">60 minutes to complete</span>.
              ...
              <p className="pb-4 font-light text-gray-800">
                <span className="font-bold ">
                  We charge $150 for a personal + business returns
                </span>{" "}
                and this is a perfect solutions for individuals and families who
                have businesses and/or real estate investments in addition to
                their personal tax needs:
              </p>
              <ul className="pb-2 pl-8 text-gray-800 list-disc">
                <li className="pb-2 font-light text-gray-800">
                  Return Requires either Schedule C (P&L for Business) or
              ...
              <p className="pb-4 font-light text-gray-800">
                Do you not have a business or rental real estate? Perhaps you’d
                be better served (and save some cash) by scheduling a 30 minute
                appointment -{" "}
                <Link href="/schedule/virtual-personal">
                  <a className="underline text-primary-700">
                    Personal Return Appointment
                  </a>
                </Link>
                .
              </p>
